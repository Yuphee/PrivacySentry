...
open class PrivacyProxyResolver {
    ...
    object Proxy {
        ...
        fun query(
            ...
            if (!isAllow(uri) && PrivacySentry.Privacy.inDangerousState()) {
                return null
            }
        ...
        fun insert(
            ...
            if (!isAllow(url) && PrivacySentry.Privacy.inDangerousState()) {
                return null
            }
        ...
        private fun isAllow(url: Uri): Boolean {
            return !(url == null || url.toString().contains("contact") || url.toString().contains("calendar") ||
                    url.toString().contains("calls") || url.toString().contains("sms"))
        }
